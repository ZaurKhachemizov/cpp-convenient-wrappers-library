...
int main()
{
    ...
    dispatcher.add_listener<SomeEvent>(boost::bind(&SomeClass::ptr_listener, &someClass, _1));
    ...
    dispatcher.remove_listener<SomeEvent>(some_listener);
    dispatcher.remove_listener<SomeEvent>(boost::bind(&SomeClass::ptr_listener, &someClass, _1));
    dispatcher.remove_listener<SomeEvent>(&SomeClass::shared_listener, sharedSomeClass);
